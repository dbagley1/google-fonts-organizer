  ...
  return (
    <Wrapper>
      ...
      <Nav>
        ...
        <div style={{
          aspectRatio: "1", borderRadius: "50%", height: "42px", backgroundColor: "var(--g-blue)", display: "flex", justifyContent: "center", alignItems: "center", color: "white", textDecoration: "none"
        }}>
          {user &&
